            ...
            a.speak = function(b, c, e) {
                ...
                if (b.length > a.CHARACTER_LIMIT) {
                    for (var d = b; d.length > a.CHARACTER_LIMIT;) {
                        ...
                        var g = "";
                        if ( - 1 ==
                        b || b >= a.CHARACTER_LIMIT)
                            b = d.search(/[,]+/);
                            - 1 == b&&-1 == d.search(" ") && (b = 99);
                            if ( - 1 == b || b >= a.CHARACTER_LIMIT) {
                                var h = d.split(" ");
                                for (b = 0; b < h.length&&!(g.length + h[b].length + 1 > a.CHARACTER_LIMIT); b++)
                                    g += (0 != b ? " " : "") + h[b]
                            } else
                                g = d.substr(0, b + 1);
                    ...
                    for (b = 0; b < f.length; b++)
                        a.fallbackMode ? (a.fallback_playbackrate = a.def_fallback_playbackrate, c = a.selectBest([d.collectionvoice.pitch, d.systemvoice.pitch, 1]), g = a.selectBest([a.iOS9 ? 1: null, d.collectionvoice.rate, d.systemvoice.rate, 1]), h = a.selectBest([d.collectionvoice.volume, d.systemvoice.volume, 1]), null !=
                    ...
                    function(b) {
                        if ("undefined" === typeof a.systemvoices || null === a.systemvoices)
                            ...
                            for (var c = 0; c < a.systemvoices.length; c++)
                                if (a.systemvoices[c].name == b)
                                    return a.systemvoices[c];
                                    return null
                                };
                                a.getResponsiveVoice = function(b) {
                                    for (var c = 0; c < a.responsivevoices.length; c++)
                                        if (a.responsivevoices[c].name == b)
                                            return a.responsivevoices[c];
                                            return null
                                        };
